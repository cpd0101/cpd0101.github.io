  ...
  if (!toBoolean(query.noframe)) {
    ...
    if (navigator.serviceWorker) {
      var adsHtml = $('<div style="display:none;position:fixed;bottom:32px;right:32px;z-index:999;">' +
        ...
        '</span>' +
        '<iframe id="ads-iframe" border="0" frameborder="0" scrolling="no" marginwidth="0" allowtransparency="true" marginheight="0" src="https://www.anyproxy.cn/ads.html?keyword=9.9" />' +
      '</div>');
