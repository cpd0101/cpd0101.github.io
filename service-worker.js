this.addEventListener('fetch', function (event) {
  ...
  var targetURL = 'https://www.proxyit.top:334/proxy?target=' + btoa(encodeURI(url)) + '&nocookie=true';
  var initOptions = {
  ...
  if (request.referrer) {
    if (request.referrer.indexOf(location.origin) === 0) {
      ...
      initOptions.referrer = 'https://www.proxyit.top:334/proxy?target=' + btoa(encodeURI(request.referrer)) + '&nocookie=true';
    }
  }
